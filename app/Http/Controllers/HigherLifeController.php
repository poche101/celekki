  ...
  public function showEpisode($id)
{
    ...
    if (!$episode) {
        // 4. Fallback Library
        $library = [
             '18' => ['title' => 'Discover How To Re-align With Gods Plan For Your Life', 'video' => 'https://s3.eu-west-2.amazonaws.com/lodams-videoshare/videos/THLEpd2u_61c461d1efb1d00007d781ed.mp4', 'poster' => 'images/discover.png'],
            ...
            '13' => ['title' => 'Easter Sunday Morning Service', 'video' => 'https://vcpout-sf01-altnetro.internetmultimediaonline.org/vcp/aa5ad237/playlist.m3u8', 'poster' => 'images/logo.png'],
