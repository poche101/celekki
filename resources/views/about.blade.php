<x-app-layout>
  ...
  <main class="bg-white font-sans text-slate-900 overflow-x-hidden">
   <section class="relative min-h-[60vh] md:min-h-[65vh] flex items-center overflow-hidden bg-slate-950">
    <div class="absolute inset-0">
        <img src="/images/pst-dee.jpg" alt="Ministry background" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-gradient-to-r from-slate-950 via-slate-900/80 to-slate-900/20"></div>
    </div>

    <div class="container mx-auto px-6 lg:px-20 relative z-10">
        <div class="max-w-2xl animate-fadeInLeft space-y-5">

            <div class="inline-flex items-center gap-2 py-1 px-3 rounded-full bg-blue-500/10 backdrop-blur-md border border-blue-400/20 shadow-sm">
                <span class="flex h-1.5 w-1.5 rounded-full bg-blue-400 animate-ping"></span>
                <span class="text-blue-300 text-[10px] font-black uppercase tracking-[0.2em]">LoveWorld Incorporated</span>
            </div>

            <h1 class="text-3xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] tracking-tight">
                Taking God's <br>
                <span class="text-blue-400">Presence</span> to Nations
            </h1>

            <p class="text-sm md:text-base text-slate-300 leading-relaxed max-w-lg font-medium opacity-90">
                A global ministry driven by a passion to see men and women discover the divine life in Christ Jesus. Experience the miraculous in every word.
            </p>
            <div class="pt-6 flex items-center gap-4">
                <div class="h-px w-10 bg-blue-500/50"></div>
                <div>
                    <p class="text-[9px] font-black text-blue-400 uppercase tracking-widest leading-none mb-1">Theme of the Year</p>
                    <p class="text-sm font-black text-white/90">The Year of Manifestation</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group p-8 rounded-[2rem] bg-white border border-slate-100 hover:shadow-xl transition-all duration-500 reveal-up" style="transition-delay: 200ms;">
                    ...
                    <p class="text-[14px] text-slate-500 leading-relaxed font-medium">One Word from God will revolutionize your life forever, establishing blessings in every area of your world.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 reveal-left">
                    <h2 class="text-3xl md:text-5xl font-black mb-6 leading-tight tracking-tight">
                        A Global <span class="text-blue-600">Identity.</span>
                    </h2>
                    <div class="space-y-4 text-base text-slate-600 font-medium max-w-md">
                        <p>Christ Embassy is not just a local assembly; it’s a vision. The Lord has called us to fulfill a very definite purpose, which is to take His divine presence to the peoples and nations.</p>
                        <p class="text-blue-600 font-black uppercase tracking-widest text-[11px]">LoveWorld Incorporated</p>
                    </div>
                </div>
    ...
    <section id="worship" class="py-20 bg-slate-50/50 relative">
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="flex items-center gap-6 mb-12">
                <div class="reveal-up shrink-0">
                    <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-2">Worship With Us</h2>
                    <p class="text-blue-600 font-bold uppercase tracking-[0.15em] text-[11px]">Experience the Miraculous</p>
                </div>
                    ...
                    <div class="bg-white rounded-[2rem] shadow-lg border border-slate-100 overflow-hidden">
                        <div class="p-6 space-y-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-[10px] font-black text-blue-600 uppercase mb-1">Weekly</p>
                                    <h4 class="text-lg font-black text-slate-900">Sunday Service</h4>
                                </div>
                                <div class="text-right">
                                    <p class="text-base font-black text-slate-900">7:00 AM</p>
                                    <p class="text-[10px] font-bold text-slate-400 uppercase">9:00 AM Session</p>
                                </div>
                            </div>
                            <div class="h-px bg-slate-100 w-full"></div>
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-[10px] font-black text-blue-600 uppercase mb-1">Wednesday</p>
                                    <h4 class="text-lg font-black text-slate-900">Mid-Week Service</h4>
                                </div>
                                <div class="text-right">
                                    <p class="text-base font-black text-slate-900">6:30 PM</p>
                                </div>
                            </div>
                        </div>
...
<style>
    ...
    .animate-fadeInLeft { animation: fadeInLeft 1s forwards cubic-bezier(0.16, 1, 0.3, 1); }
    .animate-fadeInRight { animation: fadeInRight 1s forwards cubic-bezier(0.16, 1, 0.3, 1); }
