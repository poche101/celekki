<x-app-layout>
    <div class="min-h-screen bg-slate-50 flex items-center justify-center p-4 md:p-8 overflow-y-auto">
        ...
        <div class="max-w-6xl w-full bg-white rounded-[40px] shadow-2xl shadow-slate-200/60 overflow-hidden flex flex-col md:flex-row min-h-[750px] transition-all duration-500">
            ...
            <div class="hidden md:flex md:w-1/2 bg-[#0A192F] relative items-center justify-center p-12 overflow-hidden">
                ...
                <div class="relative z-10 max-w-md text-center">
                    <div class="mb-8 inline-flex items-center justify-center w-24 h-24 bg-white/5 backdrop-blur-2xl rounded-[32px] border border-white/10 shadow-2xl transition-transform hover:scale-105 duration-300">
            ...
            <div class="w-full md:w-1/2 flex items-center justify-center p-8 lg:p-20 bg-[#FDFDFD]">
                <div class="w-full max-w-[400px] mx-auto">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input name="email" type="email" value="{{ old('email') }}" required
                                    ...
                                    class="w-full pl-12 pr-5 py-5 bg-slate-100 border-2 border-transparent rounded-2xl focus:bg-white focus:border-[#0A192F] focus:ring-0 transition-all font-medium outline-none text-slate-900">
                            </div>
                            @error('email')
                        ...
                        <div class="flex items-center ml-1">
                            ...
                            <label for="remember" class="ml-2 text-sm font-semibold text-slate-500 cursor-pointer">
                                Keep me signed in
                            </label>
                        </div>
